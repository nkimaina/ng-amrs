...
(function() {
    ...
    angular
        ...
        .directive('nickyKimaina', directive);
    ...
    function FormentryCtrl($translate, dialogs, $location,
        ...
        function activate() {
            ...
            if(_.isEmpty(vm.patient)) {
                return;
            }
            
            if(_.isEmpty(vm.tabs)) {
                ...
                CurrentLoadedFormService.formModel = vm.model;
                CurrentLoadedFormService.questionMap = vm.questionMap;
                CurrentLoadedFormService.listenersMetadata = listenersMetadata;
            }
        ...
        function subsribeToRootScopeMessages() {
            ...
            $rootScope.$on("selectedPatientChanged", function(){
                activate();
            });
        }
        ...
        function determineFormToLoad() {
            if (selectedEncounterUuid !== undefined) {
                ...
                selectedFormMetadata = FormsMetaData.getForm(that.formsDataUuid);
        ...
        function createFormFromSchema() {
            ...
            listenersMetadata = CurrentLoadedFormService.listenersMetadata;
